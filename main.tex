...
\title{\textbf{Bryx}}
\begin{position}
    Worked on software for alerting first-responders of incoming calls in Kotlin, iOS, and Android. Worked on geocoding and audio design for mobile alert-tones and station alert-tones.
\end{position}
